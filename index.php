...
<body>
	...
	<div class="wrap">
		...
		<div class="header">
			...
			<div id="heading">
				<a href="index.php"> Urban Railways</a>
			</div>
		...
		<div class="span12 well">
			...
			<div id="myCarousel" class="carousel slide" style="width:600px; float:left;margin-bottom:3px;">		
				...
				<div class="active item"><img src="images/goldenchariot.jpg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/maharaja.jpg" style="width:600px;height:350px;"/> </div>
			...
			<marquee behavior="scroll" id="marq"  scrollamount=3 direction="up" height="294px" onmouseover="nestop()" onmouseout="nestrt()">
				<div>
				<p><b>There is no proposal to extend to mail/express and superfast trains the flexi-fares currently applicable only to Rajdhani, Shatabdi and Duronto trains,  said Railways Minister Piyush Goyal.</b></p>
				</br>
